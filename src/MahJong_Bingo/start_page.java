...
public class start_page extends JPanel {
	...
	public start_page() {
		...
		// setup button for starting a new game
		...
		btnNewGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Control_Framework.switchPage(2); // switch to gaming drawing page
			}
		});
		btnNewGame.setBounds(500, 350, 190, 80);
		// end start game button
		
		// setup button for explaining game rules
		...
		// end game rules button
		
		// setup button which contains developers' info
		...
		String info = 
				"This little program is developed by Kevin Kwong, Martin Wong and Ken Tang for the NCKU exchange project.\n" + 
		...
		// this sets up the icon of the background
